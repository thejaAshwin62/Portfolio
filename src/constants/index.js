...
const testimonials = [
  {
    ...
    company: "Hackathon",
    image: "https://www.pngkit.com/png/detail/227-2275213_mahendra-engineering-college-logo.png",
  },
  {
    ...
    image: "https://th.bing.com/th/id/OIP.3aRrpGLM711-1bKOFAP90QHaFj?w=187&h=159&c=7&r=0&o=5&dpr=1.5&pid=1.7",
  },
  {
    topic:"AR Appliences",
    testimonial:
...
const projects = [
  ...
  },
  {
    name: "AR Appliences",
    description:
      "Developed an AR Appliances App using Unity with advanced AR features. The app allows users to visualize home appliances in their space, providing an immersive and interactive experience. Demonstrated expertise in AR development, Unity, and enhancing user engagement through innovative technology",
    tags: [
      {
        name: "Unity3D",
        color: "blue-text-gradient",
  ...
  },
  {
    name: "Tinger",
    description:
      "I deploy a Basic ReactJS website which extracts news/article body from a URL and uses GPT to summarize (and optionally translate) the article content. Useful for text mining purposes. Leverages powerful and flexible web scraping engine (ScrapeNinja.net) with high-quality rotating proxies under the hood.",
    tags: [
      {
        name: "React Js",
        color: "blue-text-gradient",
